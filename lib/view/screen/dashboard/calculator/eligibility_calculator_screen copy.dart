...
class EligibilityCalculatorScreen extends StatefulWidget {
  ...
  @override
  _EligibilityCalculatorScreenState createState() =>
      _EligibilityCalculatorScreenState();
}

class _EligibilityCalculatorScreenState
    extends State<EligibilityCalculatorScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Slider(
                      ...
                      inactiveColor:
                          ColorUtils.themeColor.oxff447D58.withOpacity(0.2),
                      value: _income,
                      min: 0,
                      max: 1000000,
                      divisions: 1000,
                        ...
                        setState(() {
                          if (_loanTenure == 0) {
                            Fluttertoast.showToast(
                                msg: 'Please, Select The Loan Duration');
                          } else {
                            ...
                            final availableIncome =
                                _income - _expenses - _otherLoanEMIs;
                            const installmentRatio = 0.5;
                            final monthlyInstallment =
                                (availableIncome * installmentRatio) /
                                    (1 -
                                        (1 /
                                            pow(1 + (_interestRate / 1200),
                                                _loanTenure * 12)));
                            _loanEligibility =
                                monthlyInstallment * (_loanTenure * 12);
                          }
                        });
                      },
                    ),
                                    ...
                                    Text(
                                      ...
                                      style: FontUtils.h14(
                                        fontColor: ColorUtils
                                            .themeColor.oxff000000
                                            .withOpacity(0.6),
                                      ),
                                    ),
                                    Text(
                                      _loanEligibility.isNegative
                                          ? '00/-'
                                          : NumberFormat('#,##,###', 'en_IN')
                                              .format(_loanEligibility),
                                      style: FontUtils.h22(
                                        fontColor:
